		...
		<template v-if="!showFlag">
			<el-form :style='{"margin":"0 0 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"margin":"10px 0","display":"block"}'>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						...
						<el-input v-model="searchForm.name" placeholder="情绪测评名称" clearable></el-input>
					</div>
			...
			<div :style='{"width":"100%","padding":"0px"}'>
				...
				>
					...
					<el-table-column :resizable='true' :sortable='true' prop="name" header-align="center" align="center" sortable label="情绪测评">
					...
					>
						<template slot-scope="scope">
							<el-button class="view" :style='{"border":"1px solid #00ad45","cursor":"pointer","padding":"0 5px","margin":"0 5px 5px 0","color":"#00ad45","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
