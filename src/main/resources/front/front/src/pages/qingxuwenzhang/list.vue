	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('qingxuwenzhang','新增')" type="primary" @click="add('/index/qingxuwenzhangAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
						...
						<div class="infoBox">
							...
							<div class="centerInfo">
								<div class="publisher_item">
									...
									<span class="text">{{item.zixunshizhanghao}}</span>
								</div>
								<div class="like_item">
...
<script>
	export default {
		...
		async created() {
			...
			await this.$http.get('option/qingxufenlei/qingxufenlei').then(res => {
				if (res.data.code == 0) {
					this.qingxufenleiOptions = res.data.data;
					this.selectOptionsList.push({name:'情绪分类',list:this.qingxufenleiOptions,tableName: 'qingxufenlei',check: -1})
				}
			});
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.qingxufenlei != '') searchWhere.qingxufenlei = this.formSearch.qingxufenlei;
				...
				this.$http.get(`qingxuwenzhang/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/qingxuwenzhangDetail', query: params});
			},
