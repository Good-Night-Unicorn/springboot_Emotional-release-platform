<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="编曲" prop="bianqu">
				<el-input v-model="ruleForm.bianqu" 
					placeholder="编曲" clearable :disabled=" false  ||ro.bianqu"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="填词" prop="tianci">
			...
			<el-form-item class="add-item" label="时长" prop="shizhang">
				<el-input-number v-model="ruleForm.shizhang" placeholder="时长" :disabled=" false ||ro.shizhang"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item" label="发行方" prop="faxingfang">
				<el-input v-model="ruleForm.faxingfang" 
					placeholder="发行方" clearable :disabled=" false  ||ro.faxingfang"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="版权方" prop="banquanfang">
				<el-input v-model="ruleForm.banquanfang" 
					placeholder="版权方" clearable :disabled=" false  ||ro.banquanfang"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="发行日期" prop="faxingriqi">
				<el-date-picker
