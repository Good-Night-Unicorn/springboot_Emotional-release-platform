<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="游戏名称" prop="youximingcheng">
				<el-input v-model="ruleForm.youximingcheng" 
					placeholder="游戏名称" clearable :disabled=" false  ||ro.youximingcheng"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="游戏分类" prop="youxifenlei">
			...
			<el-form-item class="add-item" label="游戏视频" v-if="type!='cross' || (type=='cross' && !ro.youxishipin)" prop="youxishipin">
				<file-upload
					tip="点击上传游戏视频"
					action="file/upload"
					:limit="1"
			...
			<el-form-item class="add-item" v-else label="游戏视频" prop="youxishipin">
				<div class="viewBtn" v-if="ruleForm.youxishipin" @click="download(baseUrl + ruleForm.youxishipin)" type="success">预览</div>
				<div class="unviewBtn" v-else disabled>暂无</div>
			</el-form-item>
			<el-form-item class="add-item" label="发售日期" prop="fashouriqi">
				<el-date-picker
					:disabled=" false  ||ro.fashouriqi"
			...
			<el-form-item class="add-item" label="制作" prop="zhizuo">
				<el-input
					type="textarea"
					:rows="8"
					placeholder="制作"
			...
			<el-form-item class="add-item" label="游戏详情" prop="youxixiangqing">
				<editor 
			...
			async onSubmit() {
				...
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`youxixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
