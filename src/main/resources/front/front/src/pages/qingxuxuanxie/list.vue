	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('qingxuxuanxie','新增')" type="primary" @click="add('/index/qingxuxuanxieAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
...
<script>
	export default {
		...
		async created() {
			...
			await this.$http.get('option/biaoqianxinxi/biaoqian').then(res => {
				if (res.data.code == 0) {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`qingxuxuanxie/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/qingxuxuanxieDetail', query: params});
			},
